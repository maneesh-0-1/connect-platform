...
import { Download, Plus, Users, QrCode as QrIcon, Search, Ban, CheckCircle, FileSpreadsheet } from 'lucide-react';
                                            ...
                                            <td className="p-4 text-right">
                                                {d.status !== 'DISABLED' ? (
                                                    <button
                                                        ...
                                                        className="text-red-400 hover:text-red-300 text-xs font-medium px-3 py-1 bg-red-900/20 rounded border border-red-900/50 hover:bg-red-900/40 transition-colors"
                                                    >
                                                        Disable
                                                    </button>
                                                ) : (
